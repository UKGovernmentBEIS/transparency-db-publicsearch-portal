...
// ***************************************************************
  ...
  const { subsidyobjective4 } = req.body;
  const { subsidyobjective5 } = req.body;
  const { subsidyobjective6 } = req.body;
  const { subsidyobjective7 } = req.body;
  const { subsidyobjective8 } = req.body;
  const { subsidyobjective9 } = req.body;
  const { subsidyobjective10 } = req.body;
  const { subsidyobjective11 } = req.body;
  ...
  var count = 0;
    ...
    if (subsidyobjective11) { check_subsidyobjective11  = "\"" + subsidyobjective11 + "\"" ; count = count + 1}
    else  { check_subsidyobjective11  = ''; }
    ...
    if (subsidyobjective12) { check_subsidyobjective12  = "\"" + subsidyobjective12 + "\"" ; count = count + 1; check_subsidyobjective12_pass = subsidyobjective12 }
    else  { check_subsidyobjective12  = ''; }
...
const { spendingsector4 } = req.body;
const { spendingsector5 } = req.body;
const { spendingsector6 } = req.body;
const { spendingsector7 } = req.body;
const { spendingsector8 } = req.body;
const { spendingsector9 } = req.body;
const { spendingsector10 } = req.body;
const { spendingsector11 } = req.body;
const { spendingsector12 } = req.body;
const { spendingsector13 } = req.body;
const { spendingsector14 } = req.body;
const { spendingsector15 } = req.body;
const { spendingsector16 } = req.body;
const { spendingsector17 } = req.body;
const { spendingsector18 } = req.body;
const { spendingsector19 } = req.body;
const { spendingsector20 } = req.body;
...
else  { check_spendingsector2  = ''; }
if (spendingsector3) { check_spendingsector3  = "\"" + spendingsector3 + "\"" ; count = count + 1 }
else  { check_spendingsector3  = ''; }
if (spendingsector4) { check_spendingsector4  = "\"" + spendingsector4 + "\"" ; count = count + 1 }
else  { check_spendingsector4  = ''; }
if (spendingsector5) { check_spendingsector5  = "\"" + spendingsector5 + "\"" ; count = count + 1 }
else  { check_spendingsector5  = ''; }
if (spendingsector6) { check_spendingsector6  = "\"" + spendingsector6 + "\"" ; count = count + 1 }
else  { check_spendingsector6  = ''; }
if (spendingsector7) { check_spendingsector7  = "\"" + spendingsector7 + "\"" ; count = count + 1 }
else  { check_spendingsector7  = ''; }
if (spendingsector8) { check_spendingsector8  = "\"" + spendingsector8 + "\"" ; count = count + 1 }
else  { check_spendingsector8  = ''; }
if (spendingsector9) { check_spendingsector9  = "\"" + spendingsector9 + "\"" ; count = count + 1 }
else  { check_spendingsector9  = ''; }
if (spendingsector10) { check_spendingsector10  = "\"" + spendingsector10 + "\"" ; count = count + 1 }
else  { check_spendingsector10  = ''; }
if (spendingsector11) { check_spendingsector11 = "\"" + spendingsector11 + "\"" ; count = count + 1 }
else  { check_spendingsector11  = ''; }
if (spendingsector12) { check_spendingsector12  = "\"" + spendingsector12 + "\"" ; count = count + 1 }
else  { check_spendingsector12  = ''; }
if (spendingsector13) { check_spendingsector13  = "\"" + spendingsector13 + "\"" ; count = count + 1 }
else  { check_spendingsector13  = ''; }
if (spendingsector14) { check_spendingsector14  = "\"" + spendingsector14 + "\"" ; count = count + 1 }
else  { check_spendingsector14  = ''; }
if (spendingsector15) { check_spendingsector15  = "\"" + spendingsector15 + "\"" ; count = count + 1 }
else  { check_spendingsector15  = ''; }
if (spendingsector16) { check_spendingsector16  = "\"" + spendingsector16 + "\"" ; count = count + 1 }
else  { check_spendingsector16  = ''; }
if (spendingsector17) { check_spendingsector17  = "\"" + spendingsector17 + "\"" ; count = count + 1 }
else  { check_spendingsector17  = ''; }
if (spendingsector18) { check_spendingsector18  = "\"" + spendingsector18 + "\"" ; count = count + 1 }
else  { check_spendingsector18  = ''; }
if (spendingsector19) { check_spendingsector19  = "\"" + spendingsector19 + "\"" ; count = count + 1 }
else  { check_spendingsector19  = ''; }
if (spendingsector20) { check_spendingsector20  = "\"" + spendingsector20 + "\"" ; count = count + 1 }
else  { check_spendingsector20  = ''; }
...
if (single_select == "Yes") 
  {
    ...
    if (spendingsector1) { actual_spending_sector = check_spendingsector1 }
    else if (spendingsector2) { actual_spending_sector = check_spendingsector2 }
    else if (spendingsector3) { actual_spending_sector = check_spendingsector3 }
    else if (spendingsector4) { actual_spending_sector = check_spendingsector4 }
    else if (spendingsector5) { actual_spending_sector = check_spendingsector5 }
    else if (spendingsector6) { actual_spending_sector = check_spendingsector6 }
    else if (spendingsector7) { actual_spending_sector = check_spendingsector7 }
    else if (spendingsector8) { actual_spending_sector = check_spendingsector8 }
    else if (spendingsector9) { actual_spending_sector = check_spendingsector9 }
    else if (spendingsector10) { actual_spending_sector = check_spendingsector10 }
    else if (spendingsector11) { actual_spending_sector = check_spendingsector11 }
    else if (spendingsector12) { actual_spending_sector = check_spendingsector12 }
    else if (spendingsector13) { actual_spending_sector = check_spendingsector13 }
    else if (spendingsector14) { actual_spending_sector = check_spendingsector14 }
    else if (spendingsector15) { actual_spending_sector = check_spendingsector15 }
    else if (spendingsector16) { actual_spending_sector = check_spendingsector16 }
    else if (spendingsector17) { actual_spending_sector = check_spendingsector17 }
    else if (spendingsector18) { actual_spending_sector = check_spendingsector18 }
    else if (spendingsector19) { actual_spending_sector = check_spendingsector19 }
    else if (spendingsector20) { actual_spending_sector = check_spendingsector20 }

  }

  if (nothing_selected == "Yes") { actual_spending_sector = '' }

  if (multiple_select == "Yes") {

    if (spendingsector1) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector1 + ","}
    if (spendingsector2) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector2 + ","}
    if (spendingsector3) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector3 + ","}
    if (spendingsector4) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector4 + ","}
    if (spendingsector5) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector5 + ","}
    if (spendingsector6) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector6 + ","}
    if (spendingsector7) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector7 + ","}
    if (spendingsector8) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector8 + ","}
    if (spendingsector9) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector9 + ","}
    if (spendingsector10) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector10 + ","}
    if (spendingsector11) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector11 + ","}
    if (spendingsector12) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector12 + ","}
    if (spendingsector13) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector13 + ","}
    if (spendingsector14) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector14 + ","}
    if (spendingsector15) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector15 + ","}
    if (spendingsector16) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector16 + ","}
    if (spendingsector17) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector17 + ","}
    if (spendingsector18) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector18 + ","}
    if (spendingsector19) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector19 + ","}
    if (spendingsector20) {  multiple_spending_sector = multiple_spending_sector + check_spendingsector20 + ","}
...
const { subsidyinstrument4 } = req.body;
const { subsidyinstrument5 } = req.body;
const { subsidyinstrument6 } = req.body;
const { subsidyinstrument7 } = req.body;
const { subsidyinstrument8 } = req.body;
...
if (subsidyinstrument2) { check_subsidyinstrument2  = "\"" + subsidyinstrument2 + "\"" ; count = count + 1 }
else  { check_subsidyinstrument2  = ''; }

if (subsidyinstrument3) { check_subsidyinstrument3  = "\"" + subsidyinstrument3 + "\"" ; count = count + 1}
else  { check_subsidyinstrument3  = ''; }

if (subsidyinstrument4) { check_subsidyinstrument4  = "\"" + subsidyinstrument4 + "\"" ; count = count + 1 }
else  { check_subsidyinstrument4  = ''; }

if (subsidyinstrument5) { check_subsidyinstrument5  = "\"" + subsidyinstrument5 + "\"" ; count = count + 1}
else  { check_subsidyinstrument5  = ''; }

if (subsidyinstrument6) { check_subsidyinstrument6  = "\"" + subsidyinstrument6 + "\"" ; count = count + 1}
else  { check_subsidyinstrument6  = ''; }

if (subsidyinstrument7) { check_subsidyinstrument7  = "\"" + subsidyinstrument7 + "\"" ; count = count + 1}
else  { check_subsidyinstrument7  = ''; }

if (subsidyinstrument8) { check_subsidyinstrument8  = "\"" + subsidyinstrument8 + "\"" ; count = count + 1}
else  { check_subsidyinstrument8  = ''; }

if (subsidyinstrument9) { check_subsidyinstrument9  = "\"" + subsidyinstrument9 + "\"" ; check_subsidyinstrument9_pass = subsidyinstrument9 ; count = count + 1}
else  { check_subsidyinstrument9  = ''; }
...
if (single_select == "Yes") 
  {
    ...
    if (subsidyinstrument1) { actual_subsidy_instrument = check_subsidyinstrument1 }
    else if (subsidyinstrument2) { actual_subsidy_instrument = check_subsidyinstrument2 }
    else if (subsidyinstrument3) { actual_subsidy_instrument = check_subsidyinstrument3 }
    else if (subsidyinstrument4) { actual_subsidy_instrument = check_subsidyinstrument4 }
    else if (subsidyinstrument5) { actual_subsidy_instrument = check_subsidyinstrument5 }
    else if (subsidyinstrument6) { actual_subsidy_instrument = check_subsidyinstrument6 }
    else if (subsidyinstrument7) { actual_subsidy_instrument = check_subsidyinstrument7 }
    else if (subsidyinstrument9) { actual_subsidy_instrument = check_subsidyinstrument9 }


  }

  if (nothing_selected == "Yes") { actual_subsidy_instrument =''}

  if (multiple_select == "Yes") {

    if (subsidyinstrument1) {  multiple_subsidy_instrument = multiple_subsidy_instrument + check_subsidyinstrument1 + ","}
    if (subsidyinstrument2) {  multiple_subsidy_instrument = multiple_subsidy_instrument + check_subsidyinstrument2 + ","}
    if (subsidyinstrument3) {  multiple_subsidy_instrument = multiple_subsidy_instrument + check_subsidyinstrument3 + ","}
    if (subsidyinstrument4) {  multiple_subsidy_instrument = multiple_subsidy_instrument + check_subsidyinstrument4 + ","}
    if (subsidyinstrument5) {  multiple_subsidy_instrument = multiple_subsidy_instrument + check_subsidyinstrument5 + ","}
    if (subsidyinstrument6) {  multiple_subsidy_instrument = multiple_subsidy_instrument + check_subsidyinstrument6 + ","}
    if (subsidyinstrument7) {  multiple_subsidy_instrument = multiple_subsidy_instrument + check_subsidyinstrument7 + ","}
    if (subsidyinstrument9) {  multiple_subsidy_instrument = multiple_subsidy_instrument + check_subsidyinstrument9 + ","}
