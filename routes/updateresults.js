...
router.post("/", async (req, res) => {
  ...
  console.log(
    "subsidyobjective11 & 12 ====" + subsidyobjective11 + subsidyobjective12
  );
  var count = 0;
  ...
  if (multiple_select == "Yes") {
    if (subsidyobjective1) {
      multiple_subsidy_objective =
        multiple_subsidy_objective + check_subsidyobjective1 + ",";
    }
    if (subsidyobjective2) {
      multiple_subsidy_objective =
        multiple_subsidy_objective + check_subsidyobjective2 + ",";
    }
    if (subsidyobjective3) {
      multiple_subsidy_objective =
        multiple_subsidy_objective + check_subsidyobjective3 + ",";
    }
    if (subsidyobjective4) {
      multiple_subsidy_objective =
        multiple_subsidy_objective + check_subsidyobjective4 + ",";
    }
    if (subsidyobjective5) {
      multiple_subsidy_objective =
        multiple_subsidy_objective + check_subsidyobjective5 + ",";
    }
    if (subsidyobjective6) {
      multiple_subsidy_objective =
        multiple_subsidy_objective + check_subsidyobjective6 + ",";
    }
    if (subsidyobjective7) {
      multiple_subsidy_objective =
        multiple_subsidy_objective + check_subsidyobjective7 + ",";
    }
    if (subsidyobjective8) {
      multiple_subsidy_objective =
    ...
    actual_subsidy_objective = multiple_subsidy_objective.substr(
      0,
      stringlength
    );
  }
  ...
  var { spendingsector0 } = req.body;
  var { spendingsector1 } = req.body;
  var { spendingsector2 } = req.body;
  var { spendingsector3 } = req.body;
  var { spendingsector4 } = req.body;
  var { spendingsector5 } = req.body;
  var { spendingsector6 } = req.body;
  var { spendingsector7 } = req.body;
  var { spendingsector8 } = req.body;
  var { spendingsector9 } = req.body;
  var { spendingsector10 } = req.body;
  var { spendingsector11 } = req.body;
  var { spendingsector12 } = req.body;
  var { spendingsector13 } = req.body;
  var { spendingsector13a } = req.body;
  var { spendingsector14 } = req.body;
  var { spendingsector15 } = req.body;
  var { spendingsector16 } = req.body;
  var { spendingsector17 } = req.body;
  var { spendingsector18 } = req.body;
  var { spendingsector19 } = req.body;
  var { spendingsector20 } = req.body;
  ...
  if (multiple_select == "Yes") {
    if (spendingsector1) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector1 + ",";
    }
    if (spendingsector2) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector2 + ",";
    }
    if (spendingsector3) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector3 + ",";
    }
    if (spendingsector4) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector4 + ",";
    }
    if (spendingsector5) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector5 + ",";
    }
    if (spendingsector6) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector6 + ",";
    }
    if (spendingsector7) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector7 + ",";
    }
    if (spendingsector8) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector8 + ",";
    }
    if (spendingsector9) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector9 + ",";
    }
    if (spendingsector10) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector10 + ",";
    }
    if (spendingsector11) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector11 + ",";
    }
    if (spendingsector12) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector12 + ",";
    }
    if (spendingsector13) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector13 + ",";
    }
    if (spendingsector13a) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector13a + ",";
    }
    if (spendingsector14) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector14 + ",";
    }
    if (spendingsector15) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector15 + ",";
    }
    if (spendingsector16) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector16 + ",";
    }
    if (spendingsector17) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector17 + ",";
    }
    if (spendingsector18) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector18 + ",";
    }
    if (spendingsector19) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector19 + ",";
    }
    if (spendingsector20) {
      multiple_spending_sector =
        multiple_spending_sector + check_spendingsector20 + ",";
    }
