!(function () {
  ...
  var t = e(function (e, t) {
        ...
        (function (e) {
                  ...
                  (function () {
                    ...
                    if (
                      ...
                      e.classList.constructor.prototype.add = function () {
                        for (
                          var e = arguments, t = arguments.length, n = 0;
                          n < t;
                          n++
                        )
                          o.call(this, e[n]);
              ...
              (function () {
                if (!window.Element || window.HTMLElement) {
                  ...
                  var e,
                    ...
                    a = (Element.prototype = o.appendChild(
                      o.createElement("*")
                    )),
                    s = {},
                    l = function (e, t) {
                      ...
                      if (1 === e.nodeType && e.constructor !== Element)
                        for (n in ((e.constructor = Element), s))
                          (o = s[n]), (e[n] = o);
                      for (; (r = t && i[++c]); ) l(r, t);
                      return e;
                    },
                  ...
                  p(
                    ...
                    function () {
                      ...
                      if (!(t[n] = !0) === u) {
                        for (
                          var o,
                            r = d.mirror || document.createElement("div"),
                            i = r.childNodes,
                            c = i.length,
                            a = 0;
                          a < c;
            ...
            o(
              ...
              function (e, t) {
                ...
                this.initHeaderAttributes(n, t),
                  ...
                  n.addEventListener(
                    "click",
                    this.onSectionToggle.bind(this, e)
                  ),
          ...
          (e.prototype.checkIfAllSectionsOpen = function () {
            var e = this.$sections.length,
              t = this.$module.querySelectorAll("." + this.sectionExpandedClass)
                .length,
              n = e === t;
            return n;
          }),
                  ...
                  (window.Event = Window.prototype.Event = function (e, t) {
                    ...
                    "createEvent" in document ||
                      ((window.addEventListener = Window.prototype.addEventListener = Document.prototype.addEventListener = Element.prototype.addEventListener = function () {
                        ...
                        c._events || (c._events = {}),
                          c._events[e] ||
                            ((c._events[e] = function (e) {
                              var t,
                                n = c._events[e.type].list,
                                o = n.slice(),
                                r = -1,
                                i = o.length;
                              for (
                            ...
                            (c._events[e].list = []),
                            c.attachEvent &&
                              c.attachEvent("on" + e, c._events[e])),
                      ...
                      (window.dispatchEvent = Window.prototype.dispatchEvent = Document.prototype.dispatchEvent = Element.prototype.dispatchEvent = function (
                        e
                      ) {
                        if (!arguments.length)
          ...
          (e.prototype.polyfillHandleInputs = function (e, n) {
            e.addEventListener("keypress", function (e) {
              ...
              (13 !== e.keyCode && 32 !== e.keyCode) ||
                ("summary" === t.nodeName.toLowerCase() &&
                  (e.preventDefault(), t.click ? t.click() : n(e)));
            }),
      ...
      e.exports = (function () {
        function e(e) {
          (this.$module = e),
            ...
            this.$textarea &&
              (this.$countMessage = e.querySelector(
        ...
        return (
              ...
              (function () {
                if (!window.Element || window.HTMLElement) {
                  ...
                  var e,
                    ...
                    a = (Element.prototype = n.appendChild(
                      n.createElement("*")
                    )),
                    s = {},
                    l = function (e, t) {
          ...
          (e.prototype.updateCountMessage = function () {
            var e = this.$textarea,
              ...
              r = this.maxLength,
              i = r - o;
            o < (r * (t.threshold ? t.threshold : 0)) / 100
              ...
              i < 0
                ? (e.classList.add("govuk-textarea--error"),
                  n.classList.remove("govuk-hint"),
                  n.classList.add("govuk-error-message"))
                : (e.classList.remove("govuk-textarea--error"),
      ...
      e.exports = (function () {
        ...
        return (
          ...
          (t.prototype.syncConditionalRevealWithInputState = function (e) {
            var t = this.$module.querySelector(
            ...
            if (t) {
              ...
              if (n.length) {
                ...
                if (
                  i.height &&
                  window.innerHeight &&
                  i.top + i.height - r < window.innerHeight / 2
                )
                  return o;
              }
            }
    ...
    p = e(function (e, t) {
      e.exports = (function () {
        function e(e) {
          (this.$module = e),
            (this.$menuButton =
              e && e.querySelector(".govuk-js-header-toggle")),
            (this.$menu =
              this.$menuButton &&
              e.querySelector(
        ...
        return (
          ...
          (e.prototype.handleMenuButtonClick = function () {
            var e = this.$menu.classList.toggle(
    ...
    f = t.nodeListForEach;
  f(document.querySelectorAll('[data-module="govuk-button"]'), function (e) {
    new r(e).init();
  }),
    f(
      document.querySelectorAll('[data-module="govuk-accordion"]'),
      function (e) {
        new o(e).init();
      }
    ),
    f(document.querySelectorAll('[data-module="govuk-details"]'), function (e) {
      new i(e).init();
    }),
    f(
      document.querySelectorAll('[data-module="govuk-error-summary"]'),
      function (e) {
        var t = new s(e);
        (t.init = function () {
          this.$module.addEventListener(
            "click",
            s.prototype.handleClick.bind(this)
          );
        }),
          t.init();
      }
    ...
    f(
      document.querySelectorAll('[data-module="govuk-character-count"]'),
      function (e) {
        new c(e).init();
      }
    ),
    ...
    f(
      document.querySelectorAll('[data-module="govuk-notification-banner"]'),
      function (e) {
        new l(e).init();
      }
    ),
    f(document.querySelectorAll('[data-module="govuk-radios"]'), function (e) {
      new u(e).init();
    }),
    f(document.querySelectorAll('[data-module="govuk-header"]'), function (e) {
      new p(e).init();
    }),
    f(document.querySelectorAll('[data-module="govuk-tabs"]'), function (e) {
      new d(e).init();
    });
})();
