    ...
    var t = e(function(e, t) {
        ...
        e.exports = function() {
            ...
            (function(e) {
                ...
                t || function(a) {
                    ...
                    Object.defineProperty = function(e, t, n) {
                        if (a && (e === window || e === document || e === Element.prototype || e instanceof Element))
                            return a(e, t, n);
            ...
            function(e) {
                ...
                t || Object.defineProperty(Function.prototype, "bind", {
                    value: function(t) {
                        var n, e = Array, o = Object, r = o.prototype, i = e.prototype, c = function c() {}, a = r.toString, s = "function" == typeof Symbol && "symbol" == typeof Symbol.toStringTag, l = Function.prototype.toString, u = function u(e) {
                            try {
                                return l.call(e),
                                !0
                            } catch (t) {
                        ...
                        for (var y, b = p.call(arguments, 1), v = m(0, h.length - b.length), w = [], E = 0; E < v; E++)
                            f.call(w, "$" + E);
                        ...
                        h.prototype && (c.prototype = h.prototype,
                        y.prototype = new c,
                        c.prototype = null),
                        y
                    }
            ...
            function(o) {
                ...
                e || function(e) {
                        ...
                        return function(r, i) {
                                ...
                                if (n.length)
                                    for (t = 0; t < n.length; ++t)
                                        if (o.test(n[t]))
                                            ...
                                            e;
                                for ("" === (a = "object" == typeof r[i] ? ("" + r[i].baseVal).replace(/^\s+|\s+$/g, "").split(o) : ("" + r[i]).replace(/^\s+|\s+$/g, "").split(o))[0] && (a = []),
                                s = {},
                                t = 0; t < a.length; ++t)
                                    s[a[t]] = !0;
                                l = a.length,
                            ...
                            c.add = function() {
                                ...
                                for (var e, t, n = 0, o = e.length; n < o; ++n)
                                    ...
                                    s[t] || (a.push(t),
                                    s[t] = !0);
                                l !== a.length && (l = a.length >>> 0,
                                "object" == typeof r[i] ? r[i].baseVal = a.join(" ") : r[i] = a.join(" "),
                                u())
                            }
                            ,
                            c.remove = function() {
                    ...
                    function() {
                        ...
                        e.classList.contains("x") && (e.classList.constructor.prototype.toggle = function(e) {
                            var t = arguments[1];
                            if (t !== o)
                                return this[(t = !!t) ? "add" : "remove"](e),
                                t;
            ...
            function(e) {
                ...
                t || function() {
                    if (!window.Element || window.HTMLElement) {
                        ...
                        var e, t = document.appendChild(document.createElement("body")), n = t.appendChild(document.createElement("iframe")), o = n.contentWindow.document, a = Element.prototype = o.appendChild(o.createElement("*")), s = {}, l = function(e, t) {
                            ...
                            for (; r = t && i[++c]; )
                                l(r, t);
                            return e
                        }, u = document.getElementsByTagName("*"), r = document.createElement, i = 100;
                        a.attachEvent("onpropertychange", function(e) {
                            for (var t, n = e.propertyName, o = !s.hasOwnProperty(n), r = a[n], i = s[n], c = -1; t = u[++c]; )
                                1 === t.nodeType && (o || t[n] === i) && (t[n] = r);
                            s[n] = r
                        }),
                        a.constructor = Element,
                        a.hasAttribute || (a.hasAttribute = function(e) {
                ...
                t || function(e) {
                    ...
                    var d = function(e, s, l) {
                        p(e.prototype, s, function() {
                            var e, t = this, n = "__defineGetter__DEFINE_PROPERTY" + s;
                            if (t[n])
                                return e;
                            if (!(t[n] = !0) === u) {
                                ...
                                o || (o = r.appendChild(document.createElement("div"))),
                                e = DOMTokenList.call(o, t, l)
                            } else
                                e = new DOMTokenList(t,l);
                    ...
                    d(e.Element, "classList", "className"),
                    d(e.HTMLElement, "classList", "className"),
                    d(e.HTMLLinkElement, "relList", "rel"),
                    d(e.HTMLAnchorElement, "relList", "rel"),
                    d(e.HTMLAreaElement, "relList", "rel")
                }(this)
            }
            .call("object" == typeof window && window || "object" == typeof self && self || "object" == typeof n && n || {}),
            ...
            e.prototype.initHeaderAttributes = function(t, e) {
                ...
                c.setAttribute("id", this.moduleId + "-heading-" + (e + 1)),
                c.setAttribute("aria-controls", this.moduleId + "-content-" + (e + 1));
                ...
                null != i && c.setAttribute("aria-describedby", this.moduleId + "-summary-" + (e + 1)),
                ...
                e || function() {
                    ...
                    if ("undefined" != typeof document && "undefined" != typeof window) {
                        ...
                        "createEvent"in document || (window.addEventListener = Window.prototype.addEventListener = Document.prototype.addEventListener = Element.prototype.addEventListener = function() {
                            ...
                            c._events[e] || (c._events[e] = function(e) {
                                ...
                                e.pageY = e.clientY + document.documentElement.scrollTop); ++r < i && !e.cancelImmediate; )
                                    r in o && (t = o[r],
                                    -1 !== a(n, t) && "function" == typeof t && t.call(c, e))
                            }
                            ,
                            c._events[e].list = [],
                        ...
                        window.removeEventListener = Window.prototype.removeEventListener = Document.prototype.removeEventListener = Element.prototype.removeEventListener = function() {
                            ...
                            t._events && t._events[n] && t._events[n].list && -1 !== (e = a(t._events[n].list, o)) && (t._events[n].list.splice(e, 1),
      ...
      , i = e(function(e, t) {
        e.exports = function() {
            ...
            e.prototype.polyfillDetails = function() {
                ...
                !(t.tabIndex = 0) == (null !== e.getAttribute("open")) ? (t.setAttribute("aria-expanded", "true"),
                n.setAttribute("aria-hidden", "false")) : (t.setAttribute("aria-expanded", "false"),
            ...
            e.prototype.polyfillSetAttributes = function() {
                ...
                return t.setAttribute("aria-expanded", o ? "false" : "true"),
                n.setAttribute("aria-hidden", r ? "false" : "true"),
            ...
            e.prototype.polyfillHandleInputs = function(e, n) {
                e.addEventListener("keypress", function(e) {
                    var t = e.target;
                    13 !== e.keyCode && 32 !== e.keyCode || "summary" === t.nodeName.toLowerCase() && (e.preventDefault(),
                    t.click ? t.click() : n(e))
                }),
        ...
        e.exports = function() {
            ...
            function(e) {
                "Element"in this && "HTMLElement"in this || function() {
                    if (!window.Element || window.HTMLElement) {
                        window.Element = window.HTMLElement = new Function("return function Element() {}")();
                        var e, t = document.appendChild(document.createElement("body")), n = t.appendChild(document.createElement("iframe")).contentWindow.document, a = Element.prototype = n.appendChild(n.createElement("*")), s = {}, l = function(e, t) {
                            var n, o, r, i = e.childNodes || [], c = -1;
                            if (1 === e.nodeType && e.constructor !== Element)
                                for (n in e.constructor = Element,
                                s)
                            ...
                            for (; r = t && i[++c]; )
                                l(r, t);
                            return e
                        }, u = document.getElementsByTagName("*"), o = document.createElement, r = 100;
                        a.attachEvent("onpropertychange", function(e) {
                            for (var t, n = e.propertyName, o = !s.hasOwnProperty(n), r = a[n], i = s[n], c = -1; t = u[++c]; )
                                1 === t.nodeType && (o || t[n] === i) && (t[n] = r);
                            s[n] = r
                        ...
                        i() || (document.onreadystatechange = i,
                        e = setInterval(i, 25)),
                        document.createElement = function(e) {
                    ...
                    if ("undefined" != typeof document && "undefined" != typeof window) {
                        ...
                        "createEvent"in document || (window.addEventListener = Window.prototype.addEventListener = Document.prototype.addEventListener = Element.prototype.addEventListener = function() {
                            ...
                            c._events[e] || (c._events[e] = function(e) {
                                ...
                                e.clientX && (e.pageX = e.clientX + document.documentElement.scrollLeft,
                                e.pageY = e.clientY + document.documentElement.scrollTop); ++r < i && !e.cancelImmediate; )
                                    r in o && -1 !== a(n, t = o[r]) && "function" == typeof t && t.call(c, e)
                            }
                            ,
                            c._events[e].list = [],
                            c.attachEvent && c.attachEvent("on" + e, c._events[e])),
            ...
            function(e) {
                ...
                t.classList.contains("b")) || function(e) {
                    var u = !0
                      , p = function(e, t, n, o) {
                        Object.defineProperty ? Object.defineProperty(e, t, {
                            configurable: !1 === u || !!o,
            ...
            e.prototype.updateCountMessage = function() {
                var e = this.$textarea
                  ...
                  , r = this.maxLength
                  , i = r - o;
                o < r * (t.threshold ? t.threshold : 0) / 100 ? (n.classList.add("govuk-character-count__message--disabled"),
                n.setAttribute("aria-hidden", !0)) : (n.classList.remove("govuk-character-count__message--disabled"),
                n.removeAttribute("aria-hidden")),
                i < 0 ? (e.classList.add("govuk-textarea--error"),
                ...
                t.maxwords && (s = "word"),
                s += -1 == i || 1 == i ? "" : "s",
                c = i < 0 ? "too many" : "remaining",
                a = Math.abs(i),
                n.innerHTML = "You have " + a + " " + s + " " + c
            }
            ,
        ...
        e.exports = function() {
            ...
            t.prototype.init = function() {
                ...
                e(this.$inputs, function(e) {
                    ...
                    t && n.querySelector("#" + t) && (e.setAttribute("aria-controls", t),
            ...
            t.prototype.syncConditionalRevealWithInputState = function(e) {
                ...
                if (t && t.classList.contains("govuk-checkboxes__conditional")) {
                    ...
                    t.classList.toggle("govuk-checkboxes__conditional--hidden", !n)
                }
            }
            ,
            ...
            e.prototype.getAssociatedLegendOrLabel = function(e) {
                ...
                if (t) {
                    ...
                    if (n.length) {
                        ...
                        if (i.height && window.innerHeight && i.top + i.height - r < window.innerHeight / 2)
                            return o
                    }
                }
      ...
      , l = e(function(e, t) {
        e.exports = function() {
            ...
            function e(e) {
                this.$module = e,
                this.$inputs = e.querySelectorAll('input[type="radio"]')
            }
            return function(e) {
                var a, s, l, u;
                "defineProperty"in Object && function() {
      ...
      , u = e(function(e, t) {
        e.exports = function() {
            function e(e) {
                ...
                this.$menu = this.$menuButton && e.querySelector("#" + this.$menuButton.getAttribute("aria-controls"))
            }
            return function(e) {
                "Window"in this || "undefined" == typeof WorkerGlobalScope && "function" != typeof importScripts && function(e) {
                    e.constructor ? e.Window = e.constructor : (e.Window = e.constructor = new Function("return function Window() {}")()).prototype = this
